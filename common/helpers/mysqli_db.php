...
/*
| -------------------------------------------------------------------------
| mysqli_db.php [rev 1.0], Назначение: работа с базой данных
| -------------------------------------------------------------------------
| В этом файле имеются готовые функции для удобной работы с базой данных,
| таблицами MySQL.
| Используется, например, в хелпере blog и других.
|
|
@
