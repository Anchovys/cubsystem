...
/*
| -------------------------------------------------------------------------
| html_minity.php [rev 1.0], Назначение: сокращение html-кода страниц.
| -------------------------------------------------------------------------
| Используется движком для сокращения выходного html-кода
| для сжатия его размера.
|
**
**  Tiny-html-minifier, rev. 2.2 (с) 2019
**  Author: jenstornell
**  GitHub: //github.com/jenstornell/tiny-html-minifier
**
@
@   Cubsystem CMS since rev 0.4, (с) 2020
@   Author: Anchovy
@   GitHub: //github.com/Anchovys/cubsystem
@
*/

class html_minify_helper
{
    private $options;
    private $output;
    private $build;
