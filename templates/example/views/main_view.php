        ...
        <div class="row">
            <div class="col-12">
                <div class="mm__horizontal_menu">
                    <ul>
                        <li><a href="{{cs_abs_url()}}" class="mm_menu_item">Home</a></li>
                        <li><a href="{{cs_abs_url('login')}}" class="mm_menu_item">Login</a></li>
                        <li><a href="{{cs_abs_url('register')}}" class="mm_menu_item">Register</a></li>
                        <li><a href="{{cs_abs_url('admin')}}" class="mm_menu_item">Admin panel</a></li>
